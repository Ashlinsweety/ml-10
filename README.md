...
## Algorithm
1. Import libraries and load the weather dataset.
2. Prepare input features and target weather data.
3. Train the RandomForestClassifier model using training data.
4. Predict weather conditions and evaluate model accuracy.
...
## Output:
<img width="575" height="300" alt="image" src="https://github.com/user-attachments/assets/b10a7b78-3244-453c-a66c-b91298c218ef" />
